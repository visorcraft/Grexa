...
ui-profile-name-example = z. B. "TODOs in ~/code"
...
ui-no-matches-for-query = Keine Treffer für „%1“.
ui-regex-builder-placeholder = Muster
ui-residual-journal-summary = Wurzel: %1\nSuchbegriff: %2\nErsetzung: %3\nGeändert: %4\nFehlgeschlagen: %5
ui-tools-section = Werkzeuge
ui-try-one-of-these = Versuchen Sie eines dieser
ui-whats-inside = Was ist enthalten
ui-workspace-section = Arbeitsbereich
