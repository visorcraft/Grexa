...
credits:
    ...
    # cargo-about embeds upstream license texts with CRLF and trailing spaces;
    # normalize both so the include_str!'d bundle and generated Markdown stay clean.
    sed -i -e 's/\r$//' -e 's/[[:blank:]]*$//' docs/credits-third-party.md
